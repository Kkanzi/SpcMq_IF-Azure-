...
{
    public class syncGoodsInspect : IJob
    {
        ...
        public void Run()
        {
            ...
            try
            {
                                                                ...
                                                                Properties.Settings.Default.BadKey.ToString()))
                {
                    ...
                    dbconn.CmdText = UTIL.DBQuery.GoodsInspectProc;
                    ...
                    isok = SpcCore.syncGoodsInspect(CustomerCode, ds.Tables[0]);
                    ...
                    if (isok)
                    {
                        ...
                        log.Debug("품번별 검사스펙정보 " + ds.Tables[0].Rows.Count + "건 전송완료 IDXKEY : (" + idxkey + ")");
                        Msg("품번별 검사스펙정보 " + ds.Tables[0].Rows.Count + "건 전송완료", 1);
                    }
                }
            }
            catch (Exception ie)
