...
{
    public class syncAbnormalList : IJob
    {
        ...
        public void Run()
        {
            ...
            try
            {
                ...
                { 
                    ...
                    dbconn.CmdText = UTIL.DBQuery.AbnormalListProc;
                    ...
                    isok = SpcCore.syncAbnormalList(CustomerCode, ds.Tables[0]);
                    ...
                    if (isok)
                    {
                        ...
                        log.Debug("이상점 발생 "+ ds.Tables[0].Rows.Count + "건 전송완료 IDXKEY : (" + idxkey + ")");
                        Msg("이상점 발생 " + ds.Tables[0].Rows.Count + "건 전송완료", 1);
                    }
                }
