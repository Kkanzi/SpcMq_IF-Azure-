...
{
    public class syncInspectData : IJob
    {
        ...
        public void Run()
        {
            ...
            try
            {
                                                                ...
                                                                Properties.Settings.Default.BadKey.ToString()))
                {
                    ...
                    dbconn.CmdText = UTIL.DBQuery.InspectDataProc;
                    ...
                    // 검사 측정 값 전송
                    isok = SpcCore.syncInspectData(CustomerCode, ds.Tables[0]);
                    ...
                    if (isok)
                    {
                        ...
                        log.Debug("측정값 데이터 " + ds.Tables[0].Rows.Count + "건 전송완료 IDXKEY : (" + idxkey + ")");
                        Msg("측정값 데이터 " + ds.Tables[0].Rows.Count + "건 전송완료", 1);
                    }
                }
            }
            catch (Exception ie)
