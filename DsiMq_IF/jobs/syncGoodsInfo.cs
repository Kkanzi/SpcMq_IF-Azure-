...
{
    public class syncGoodsInfo : IJob
    {
        ...
        public void Run()
        {
            ...
            try
            {
                                                                ...
                                                                Properties.Settings.Default.BadKey.ToString()))
                {
                    ...
                    dbconn.CmdText = UTIL.DBQuery.GoodsInfoProc;
                    ...
                    isok = SpcCore.syncGoodsInfo(CustomerCode, ds.Tables[0]);
                    ...
                    if (isok)
                    {
                        ...
                        log.Debug("품번정보 " + ds.Tables[0].Rows.Count + "건 전송완료 IDXKEY : (" + idxkey + ")");
                        Msg("품번정보 " + ds.Tables[0].Rows.Count + "건 전송완료", 1);
                    }
                }
            }
            catch (Exception ie)
