...
{
    public class syncInspectInfo : IJob
    {
        ...
        public void Run()
        {
            ...
            try
            {
                                                                ...
                                                                Properties.Settings.Default.BadKey.ToString()))
                {
                    ...
                    dbconn.CmdText = UTIL.DBQuery.InspectInfoProc;
                    ...
                    isok = SpcCore.syncInspectInfo(CustomerCode, ds.Tables[0]);
                    ...
                    if (isok)
                    {
                        ...
                        log.Debug("검사항목 정보 " + ds.Tables[0].Rows.Count + "건 전송완료 IDXKEY : (" + idxkey + ")");
                        Msg("검사항목 정보 " + ds.Tables[0].Rows.Count + "건 전송완료", 1);
                    }
                }
            }
            catch (Exception ie)
